var MP3FileReader = require('./FrameReader');
    ...
    MP3FrameSplitter.prototype._flushFragment = function() {
        if(this._currentFragment && this._currentFragment.range) {
            ...
            var duration = getMP3Duration(this._lastMP3Header, this._currentFragment.frameCount);
        ...
        if(!this._currentFragment) {
            this._currentFragment = {
                ...
                sampleRate: null,
                frameCount: 0,
                timestampOffset: this._lastMP3Header ? getMP3Duration(this._lastMP3Header, this._lastFrameCount) : this._lastTimestampOffset,
                range: null
            };
        }
        this._lastMP3Header = null;
